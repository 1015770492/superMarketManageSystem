    ...
    <div class="col-lg-4 col-md-offset-4">
        <form action="register.do" class="form" >
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-lg-9 col-lg-push-1  input-group">
            ...
            <div class="row">
                <div class=" col-xs-7">
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-12 col-lg-push-2 input-group">
                ...
                <div class="col-lg-4 col-lg-push-1" style="padding-top: 30px">
                    <div id="idcode" style="background: transparent;width:80px"></div>
                </div>
            </div>
...
<%--                        <div class="col-lg-9 col-lg-push-2 input-group">--%>
<%--                            <span class="input-group-addon"><span class="glyphicon glyphicon-qrcode"></span></span>--%>
